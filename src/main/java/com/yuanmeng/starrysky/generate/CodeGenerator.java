package com.yuanmeng.starrysky.generate;
...
public class CodeGenerator {
    ...
    private static final String database = "starrysky";
    ...
    public static void main(String[] args) {
        generate("zsh","com.yuanmeng.starrysky", "");
    }
    ...
    public static void generate(String author, String packageName, String... tablePrefix) {
        ...
        for (String tableName : names.keySet()) {
            ...
            //TemplateConfig templateConfig = new TemplateConfig().setEntity("templates/entity333.java");
            //mpg.setTemplate(templateConfig);

            // 策略配置
            StrategyConfig strategy = initStrategyConfig(tableName, tablePrefix);
            //strategy.setSuperEntityClass("com.yuanmeng.starrysky.config.BaseEntity");
